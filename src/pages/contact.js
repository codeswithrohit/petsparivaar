                    ...
                    <ul class="mt-16 space-y-10">
                        <li class="flex items-center max-lg:justify-center">
                            ...
                            <a href="javascript:void(0)" class="text-white text-sm ml-3">
                                <strong>vurydubz@gmail.com</strong>
                            </a>
                        </li>
                        <li class="flex items-center max-lg:justify-center">
                    ...
                    <form>
                        <div class="grid sm:grid-cols-2 gap-8">
                            ...
                            <div class="col-span-full">
                                <h6 class="text-sm text-gray-400">Select Pet Service</h6>
                                <div class="flex max-lg:flex-col lg:space-x-6 max-lg:space-y-6">
                                    <div class="flex items-center mt-3">
                                        ...
                                        <p class="text-sm ml-3">Pet Boarding</p>
                                    </div>
                                    <div class="flex items-center mt-3">
                                        ...
                                        <p class="text-sm ml-3">Pet Sitting</p>
                                    </div>
                                    <div class="flex items-center mt-3">
                                        ...
                                        <p class="text-sm ml-3">Pet Care</p>
                                    </div>
                                </div>
                            </div>
                        </div>
